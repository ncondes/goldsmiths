...
Officer: 5031189
CaseNum: 402-1-29276970-5031189
...
function draw() {
   ///////////////////ADD YOUR CODE HERE///////////////////
   if (currentRoad === 'Romero Avenue' || currentRoad === 'Huffman Street') {
      det.speedX = 0;
      det.speedY = 1;
   }
   if (
      currentRoad === 'Meyers Way' ||
      currentRoad === 'Dijkstra Street' ||
      currentRoad === 'Reynolds Street'
   ) {
      det.speedX = 1;
      det.speedY = 0;
   }
