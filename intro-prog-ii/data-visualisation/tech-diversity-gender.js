   ...
   this.draw = function () {
      ...
      for (var i = 0; i < this.data.getRowCount(); i++) {
         ...
         var company = {
            ...
            name: this.data.rows[i].obj.name,
            female: Number(this.data.rows[i].obj.female),
            male: Number(this.data.rows[i].obj.male),
         }
         ...
         rect(
            this.mapPercentToWidth(company.female) + this.layout.leftMargin,
            lineY,
